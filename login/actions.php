...
switch($action){
	...
	$appid 		= "xxxxxxxxxxxxxxxx"; //replace your app id 
	$appsecret  = "xxxxxxxxxxxxx";// replace your secret key
	...
	if ($fbuser) {
		...
		echo $user_fbid	= $fbuser."<br>";
		
		echo $user_email = $user_profile["email"]."<br>";
		$user_fnmae = $user_profile["first_name"];
		echo "<img src=".$user_image = "https://graph.facebook.com/".$user_fbid."/picture?type=large".">";
...
window.fbAsyncInit = function() {
	FB.init({
	appId      : 'xxxxxxx', // replace your app id here
	channelUrl : 'xxxxxxxxxxx', //replace your domain name
	status     : true, 
	cookie     : true, 
	xfbml      : true  
	});
